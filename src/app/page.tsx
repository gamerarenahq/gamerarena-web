...
export default function GamerarenaMasterERP() {
  ...
  return (
    <>
      ...
      {/* 🟢 MOBILE FIX: Removed strict 'h-screen' wrapping. Native block scroll on mobile. */}
      <div className="min-h-screen bg-[#05070A] text-white font-sans pb-20 lg:pb-0 lg:flex lg:flex-row lg:overflow-hidden w-full">
        ...
        {/* MAIN CONTENT AREA */}
        <div className="w-full max-w-[1600px] mx-auto p-3 lg:ml-16 lg:flex lg:flex-col lg:h-screen lg:overflow-hidden">
            ...
            {/* 🟢 SYSTEM CARDS GRID (Mobile: Block stretching. Desktop: Locked 100% height) */}
