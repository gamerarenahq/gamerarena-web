...
import { X, User, Clock, ArrowRightLeft, Plus, Minus, Gamepad2, Monitor, Car, IndianRupee, Package, BarChart3, ShoppingCart, MoonStar, Copy, Lock, Tag, Building2, Edit2, Trash2, Users, Book } from 'lucide-react';
...
export default function GamerarenaMasterERP() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#05070A] text-white font-sans pb-20 lg:pb-0 lg:flex lg:flex-row lg:overflow-hidden w-full">
        ...
        {/* MAIN CONTENT AREA */}
        <div className="w-full max-w-[1600px] mx-auto p-3 lg:flex lg:flex-col lg:h-screen lg:overflow-hidden">
            
            {/* HEADER */}
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-3 mb-4 w-full lg:shrink-0 min-w-0">
            ...
            {/* 🟢 SYSTEM CARDS GRID */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full lg:flex-1 lg:min-h-0 lg:overflow-y-auto custom-scrollbar lg:pb-4">
              {SYSTEMS.map((sys, index) => {
                ...
                return (
                  <div key={sys.id} className={`flex flex-col p-4 rounded-2xl border transition-all duration-300 lg:h-full lg:overflow-y-auto custom-scrollbar bg-[#0B0E14] ${activeSession ? (isOverdue ? 'border-red-500/50 shadow-[0_0_15px_rgba(239,68,68,0.1)]' : 'border-[#00D0FF]/40') : 'border-[#1E293B] hover:border-[#2D3748]'}`}>
                      ...
                      <div className="flex flex-col gap-3 lg:flex-1 lg:min-h-0">
                          ...
                          <div className={`rounded-xl p-2 sm:p-3 border ${isOverdue ? 'bg-red-950/30 border-red-900/50' : 'bg-[#05070A]/50 border-[#1E293B]'} flex flex-col justify-between shrink-0`}>
                            <div className="space-y-1">
                                {holdTotal > 0 && (
                                  <div className="flex justify-between items-center text-[10px] font-bold text-orange-400 bg-orange-500/10 px-2 py-1 rounded-lg">
                          ...
                          <div className="flex flex-col gap-2 shrink-0 mt-auto pt-2">
                            <button onClick={() => triggerCheckoutModalFromRef(activeSession)} className={`w-full text-black py-2 rounded-xl font-black text-xs sm:text-sm transition-all ${isOverdue ? 'bg-red-500 hover:bg-white' : 'bg-[#00D0FF] hover:bg-white'}`}>
        ...
        {/* 🟢 SAFE MODAL OVERLAY */}
        {modal && (
          <div id="modal-backdrop" className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm overflow-y-auto p-4 sm:p-6 flex items-center justify-center">
                ...
                {modal.type === 'fnb' ? (
                   <div className="flex flex-col lg:flex-row w-full bg-[#05070A] rounded-b-2xl overflow-hidden">
                      ...
                      <div className="flex-1 flex flex-col border-b lg:border-b-0 lg:border-r border-[#1E293B]">
                         ...
                         <div className="w-full p-4 lg:max-h-[60vh] lg:overflow-y-auto custom-scrollbar bg-[#0B0E14]">
                      ...
                      <div className="w-full lg:w-80 xl:w-96 flex flex-col shrink-0 bg-[#0B0E14]">
                         ...
                         <div className="p-4 border-t border-[#1E293B] shrink-0 bg-[#121824] rounded-br-2xl">
                   ...
                   <div className="p-4 sm:p-6 w-full lg:max-h-[75vh] overflow-y-auto custom-scrollbar bg-[#05070A] rounded-b-2xl">
