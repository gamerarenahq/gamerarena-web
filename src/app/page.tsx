...
export default function GamerarenaMasterERP() {
  ...
  return (
    <>
      ...
      {/* 🟢 REMOVED 'fixed inset-0 overflow-hidden'. Allow native scrolling on mobile. */}
      <div className="min-h-screen flex flex-col md:flex-row bg-[#05070A] text-white font-sans pb-16 md:pb-0">
        
        {/* DESKTOP SIDEBAR */}
        <div className="hidden md:flex w-16 bg-[#0B0E14] border-r border-[#1E293B] flex-col items-center py-4 shrink-0 z-10 gap-4 fixed left-0 top-0 bottom-0">
        ...
        {/* MAIN CONTENT AREA */}
        <div className="flex-1 w-full max-w-[1600px] mx-auto p-2 sm:p-4 md:ml-16">
            
            {/* 🟢 HEADER */}
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-3 mb-4 w-full">
              ...
              <div className="flex overflow-x-auto hide-scrollbar gap-2 items-center w-full xl:w-auto pb-1 sm:pb-0 snap-x">
            ...
            {/* 🟢 SYSTEM CARDS GRID (Natural Scrolling) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 w-full">
              {SYSTEMS.map((sys, index) => {
                ...
                return (
                  <div key={sys.id} className={`flex flex-col justify-between p-3 sm:p-4 rounded-2xl border transition-all duration-300 ${activeSession ? (isOverdue ? 'border-red-500/50 bg-red-950/20 shadow-[0_0_15px_rgba(239,68,68,0.1)]' : 'border-[#00D0FF]/40 bg-[#00D0FF]/5') : 'border-[#1E293B] bg-[#0B0E14] hover:border-[#2D3748]'}`}>
          ...
          <div id="modal-backdrop" className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-2 sm:p-5 overflow-hidden">
            <div className="bg-[#121824] border border-[#1E293B] rounded-2xl flex flex-col shadow-2xl relative w-full overflow-hidden transition-all duration-200"
              ...
              <div className="flex-1 overflow-hidden flex flex-col w-full">
                ...
                {modal.type === 'fnb' ? (
                   <div className="flex flex-col md:flex-row h-full w-full bg-[#05070A]">
                      
                      {/* LEFT PANEL: Menu (Scrolls naturally) */}
                      <div className="flex-1 flex flex-col min-h-0 border-b md:border-b-0 md:border-r border-[#1E293B] overflow-hidden">
                         ...
                         <div className="flex-1 overflow-y-auto w-full p-3 sm:p-4 custom-scrollbar bg-[#0B0E14]">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-3 w-full pb-4">
                               {cafeMenu
                      ...
                      <div className="w-full md:w-80 lg:w-96 flex flex-col shrink-0 bg-[#0B0E14] h-[45%] md:h-full border-t md:border-t-0 border-[#1E293B]">
